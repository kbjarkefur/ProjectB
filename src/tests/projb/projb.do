    ...
    * Use reproot to manage root path
    reproot, project("projb") roots("clone") prefix("projb_")
    ...
    * Make sure the version of projb in the dev environment us up to date with all edits.
    cap net uninstall projb
    net install projb, from("${projb_clone}/src") replace

    ************************
    * Run tests

    * Test basic case of the command projb
    projb
